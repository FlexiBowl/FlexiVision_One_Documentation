...
```
:::{important}
The parameters can be adjusted using sliders or entered manually via the keyboard in the corresponding numeric field.
:::
...
:::
:::{important}
If the parameters are changed but not synchronized, a warning message will appear.
:::
